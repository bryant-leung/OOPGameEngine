...
public class Feature extends GameObject {
    ...
    /**
     * Returns a string representation of the feature, matching the format specified in the test.
     *
     * @return a string describing the feature
     */
    @Override
    public String toString() {
        return "GameObject {id='" + getId() + "', name='" + getName() + "', description='" + getDescription() + "', hidden=" + getHidden() + "}";
    }
}
